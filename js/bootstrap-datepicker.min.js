  ...
  Datepicker.prototype = {
    ...
    _process_options: function (opts) {
      ...
      if (o.multidate !== !0) {
        ...
        if (o.multidate !== !1) o.multidate = Math.max(0, o.multidate);
      }
    ...
    fill: function () {
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        if (this.o.beforeShowDay !== $.noop) {
          ...
          if (before.enabled === !1) clsName.push("disabled");
          if (before.classes)
    ...
    moveAvailableDate: function (date, dir, fn) {
      do {
        ...
        if (!this.dateWithinRange(date)) return !1;
        fn = "moveDay";
  ...
  var DPGlobal = {
    ...
    parseDate: function (date, format, language, assumeNearby) {
      ...
      var part_re = /([\-+]\d+)([dmwy])/,
        ...
        fn_map = { d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear" },
